currentBuild.displayName = "UAPI #"+currentBuild.number
pipeline{
            ...
            steps{
               ...
               sshagent(['tomcat-user']) {
                   ...
                   sh """
                        ...
                        ssh ubuntu@54.153.65.176 /opt/tomcat9/bin/shutdown.sh
                        ssh ubuntu@54.153.65.176 /opt/tomcat9/bin/startup.sh
